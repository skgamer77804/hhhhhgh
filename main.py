...
OWNER_USERNAME = '@sgcheats04' # add your telegram username here. example: '@itzpaglu'
REQUIRED_CHANNEL = 'sgcheats04' # add your required channel username here. example: '@paglu_dev'. if you dont have any channel then leave it blank.
